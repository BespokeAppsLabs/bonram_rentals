...
export default function AccountInvoicesPage() {
    ...
    if (!dbUser || !invoices) {
        return (
            <div>
                <h1 className="text-2xl font-heading font-bold text-navy mb-6">Invoices</h1>
    ...
    return (
        <div>
            <h1 className="text-2xl font-heading font-bold text-navy mb-1">Invoices</h1>
            ...
            {invoices.length === 0 ? (
                <div className="bg-white rounded-xl border border-gray-light p-8 text-center">
                    ...
                    <p className="text-sm text-gray mt-1">Invoices will appear here once created by the admin.</p>
                </div>
            ) : (
                            ...
                            {invoices.map((inv: any) => (
                                <tr key={inv._id} className="hover:bg-mist/50">
                                    ...
                                    <td className="px-4 py-3 text-right">
                                        <Link href={`/account/invoices/${inv._id}`}
